...
<div class="container-fluid kz-table-design">
  ...
  {:else if dataset.length > 0}
    <div class="row justify-content-center">
      <div class="col col-4 kz-head uni-sans-heavy">Title</div>
      <div class="col col-3 kz-head uni-sans-heavy">Clicks</div>
      <div class="col col-5 kz-head uni-sans-heavy">Actions</div>
    </div>
